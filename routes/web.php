...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/kapal/print', [KapalController::class, 'cetak_pdf'])->name('kapal.print');
    Route::post('/kapal/print-excel', [KapalController::class, 'cetak_excel'])->name('kapal.print-excel');
