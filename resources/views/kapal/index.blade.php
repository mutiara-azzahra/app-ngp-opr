                ...
                <form class="ui form" action="{{ route('bendera.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="field">
                                <div class="ui fluid search selection dropdown">
                                    ...
                                    <div class="menu">
                                        ...
                                        <div class="item" name="{{ $i->JENIS_KAPAL }}">{{ $i->JENIS_KAPAL}} / {{ $i->G1}}</div>
                                        @endforeach
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="field">
                            ...
                            <div class="field">
                                <div class="ui fluid search selection dropdown">
                                    <input type="hidden" name="country">
                                    <i class="dropdown icon"></i>
                                    <div class="default text">Pilih Negara Kapal</div>
                                    <div class="menu">
                                        @foreach($bendera as $i)
                                        <div class="item" name="{{ $i->KODE_BENDERA }}">{{ $i->KODE_BENDERA}} / {{ $i->ASAL_NEGARA}}</div>
                                        @endforeach
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="two fields">
                        ...
                        <div class="field">
                            ...
                            <input type="text" name="gross_ton">
                        </div>
                    </div>
                    <div class="two fields">
                        <div class="field">
                    ...
                    <div class="two fields">
                        <div class="field">
                            ...
                            <input type="text" name="kecepatan_maksimal">
                        </div>
                        <div class="field">
                            <label>Kapasitas Kargo
                            </label>
                    ...
                    <div class="two fields">
                        <div class="field">
                            ...
                            <input type="text" name="kapasitas_penumpang">
                        </div>
                        <div class="field">
                            <label>Tahun Pembuatan
                            </label>
