...
<head>
    ...
    <title>Master Data Owneship</title>
    <style>
    h4,h2{
        ...
        <table class="table atas" style="line-height: 12px;">
            <tr>
                ...
                <td class="atas">
                    <table class="atas" style="line-height: 13px;">
                        <tr>
                            <td class="atas"><b>Data Ownership</b></td>
                        </tr>
                        <tr>
                            <td class="atas"></td>
                        </tr>
            ...
            <table class="table table-bawah">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="td-part">{{ $i->KODE_OWNERSHIP }}</td>
                        <td class="td-part">TEST</td>
                        <td class="td-qty">TEST</td>
                        <td class="td-angka">TEST</td>
                        <td class="td-angka">TEST</td>
                        <td class="td-angka">TEST</td>
                    </tr>
                    @endforeach
