    ...
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            ...
            <div class="page-pretitle"></div>
                <h2 class="page-title">Master Data Ownership Kapal</h2>
            </div>
        </div>
    </div>
</div>
                    ...
                    <div class="table-responsive">
                        <div class="card-header d-flex">
                            <div class="row">
                                ...
                                <div class="col-auto ms-auto d-print-none">
                                    <div class="btn-list">
                                        <a href="{{ route('ownership.cetak') }}" class="btn btn-warning w-100" data-bs-toggle="modal" data-bs-target="#modal-report">
                                ...
                                <div class="modal modal-blur fade" id="modal-report" tabindex="-1" role="dialog" aria-hidden="true">
                                    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form action="{{ route('ownership.cetak') }}" method="POST" id="data-table">
                                            @csrf
                        ...
                        <table class="table card-table table-vcenter text-nowrap datatable" id="data-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    @endif 
                                    <td class="text-center">
                                        <a href="{{ route('ownership.show', $i->FLAG_IDX) }}" class="btn btn-warning w-5 btn-icon" aria-label="">
