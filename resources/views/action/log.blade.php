    ...
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            ...
            <div class="page-pretitle"></div>
                <h2 class="page-title">DATA LOG ACTION</h2>
            </div>
            <!-- Page title actions -->
            <div class="col-auto ms-auto d-print-none">
                <div class="btn-list">
                    <a href="{{ route('action.index') }}" class="btn btn-success d-none d-sm-inline-block" target="_blank">
