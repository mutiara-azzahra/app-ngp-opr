    ...
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            ...
            <div class="page-pretitle"></div>
                <h2 class="page-title">Master Data Repair List</h2>
            </div>
                    ...
                    <div class="table-responsive">
                        <div class="card-header d-flex">
                            <div class="row">
                                        ...
                                        <div class="modal-dialog modal-sm" role="document">
                                            ...
                                            <div class="modal-footer" id="deleteButton" style="display: none">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col">
                                                    <form action="{{ route('repair-list.destroy') }}" method="POST" id="data-table">
                                                        @csrf
                                ...
                                <div class="col-auto ms-auto d-print-none">
                                    <div class="btn-list">
                                        <a href="{{ route('repair-list.create') }}" class="btn btn-success w-100">
                        ...
                        <table class="table card-table table-vcenter text-nowrap datatable" id="mytable">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">KODE REPAIR LIST</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-left">{{ $i->KODE_REPAIR_LIST }}</td>
