                                    ...
                                    <div class="modal-footer" id="deleteButton" style="display: none">
                                        <div class="w-100">
                                            <div class="row">
                                                ...
                                                <div class="col">
                                                    <button class="btn btn-danger btn w-100" type="submit" id="buttonHapus">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-trash">
                                                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                                            <path d="M4 7l16 0" />
                                                            <path d="M10 11l0 6" />
                            ...
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="mb-3">
                                                    ...
                                                    <select name="pilih_cetak" id="pilihan_cetak" onchange="updateCount()" class="form-select">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <div class="col">
                                            <button class="btn btn-primary btn w-100" type="submit" id="buttonCetak">Cetak Data</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
