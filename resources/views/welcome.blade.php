            ...
            <ul class="navbar-nav pt-lg-3">
                ...
                <div class="dropdown-menu">
                  <div class="dropdown-menu-columns">
                    <div class="dropdown-menu-column">
                      <a class="dropdown-item" href="{{ route('action.index') }}">
                        Action
                      </a>
                      <a class="dropdown-item" href="{{ route('cuser.index') }}">
                        Cuser
                      </a>
                      <a class="dropdown-item" href="{{ route('error.index') }}">
                        Error
                      </a>
                      <a class="dropdown-item" href="{{ route('etc.index') }}">
                        Etc
                      </a>
                      ...
                      <a class="dropdown-item" href="{{ route('print.index') }}">
                        Print
                      </a>
                      <a class="dropdown-item" href="{{ route('reindex.index') }}">
                        Reindex
                      </a>
                    </div>
                  </div>
			  ...
			  <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu">
                  <div class="dropdown-menu-columns">
                    <div class="dropdown-menu-column">
                      <a class="dropdown-item" href="{{ route('master-perusahaan.index') }}">
                        Master Perusahaan
                      </a>
                    </div>
					          <div class="dropdown-menu-column">
                      <a class="dropdown-item" href="{{ route('master-kapal.index') }}">
                        Kapal
                      </a>
                    </div>
                    <div class="dropdown-menu-column">
