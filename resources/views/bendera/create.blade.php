            ...
            <div class="col-12">
                <div class="card">
                    <div class="col-lg-8 col-lg-12">
                        <div class="row row-cards">
                            <div class="col-12">
                            <form class="card" action="{{ route('bendera.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                                <div class="card-body">
                                    <div class="row row-cards">
                                        <div class="col-sm-6 col-md-12 col-lg-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="kode_bendera" placeholder="Isi kode bendera">
                                            </div>
                                        </div>
                                        <div class="col-sm-6 col-md-12 col-lg-12">
                                            <div class="mb-3">
                                                <label class="form-label">Asal Negara</label>
                                                <input type="text" class="form-control" name="asal_negara" placeholder="Isi asal negara">
                                            </div>
                                        </div>
                                        <div class="col-sm-6 col-md-12 col-lg-12">
                                            <div class="mb-3">
                                                <label class="form-label">Catatan *opsional</label>
                                                <input type="text" class="form-control" name="note" placeholder="Isi catatan">
                                            </div>
                                        </div>
                                    </div>
                                </div>
