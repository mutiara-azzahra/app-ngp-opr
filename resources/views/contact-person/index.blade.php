    ...
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            ...
            <div class="page-pretitle"></div>
                <h2 class="page-title">Master Data Contact Person Kapal</h2>
            </div>
        </div>
    </div>
</div>
                    ...
                    <div class="table-responsive">
                        <div class="card-header d-flex">
                            <div class="row">
                                                ...
                                                <div class="modal-footer" id="deleteButton" style="display: none">
                                                    <div class="w-100">
                                                        <div class="row">
                                                            ...
                                                            <div class="col">
                                                            <form action="{{ route('contact-person.destroy') }}" method="POST" id="data-table">
                                                                @csrf
                                ...
                                <div class="col-auto ms-auto d-print-none">
                                    <div class="btn-list">
                                        <a href="{{ route('contact-person.create') }}" class="btn btn-success w-100">
                                ...
                                <div class="col-auto ms-auto d-print-none">
                                    <div class="btn-list">
                                        <a href="{{ route('contact-person.cetak') }}" class="btn btn-warning w-100" data-bs-toggle="modal" data-bs-target="#modal-report">
                                ...
                                <div class="modal modal-blur fade" id="modal-report" tabindex="-1" role="dialog" aria-hidden="true">
                                    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form action="{{ route('contact-person.cetak') }}" method="POST" id="data-table">
                                            @csrf
                        ...
                        <table class="table card-table table-vcenter text-nowrap datatable" id="data-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    @endif 
                                    <td class="text-center">
                                        <a href="{{ route('contact-person.edit', $i->FLAG_IDX) }}" class="btn btn-info w-5 btn-icon" aria-label="">
